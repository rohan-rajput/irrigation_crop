...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Add New Owner and Land</h3>
  <form action="" method="POST">
    <div class="form-group">
      <label for="pname">Name of employee</label>
      <input type="text" class="form-control" id="pname" name="pname">
    </div>
    <div class="form-group">
      <label for="pdop">Date </label>
      <input type="date" class="form-control" id="pdop" name="pdop">
    </div>
    <div class="form-group">
      <label for="pava">Available Land(in acres)</label>
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-dark" id="psubmit" name="psubmit">Submit</button>
